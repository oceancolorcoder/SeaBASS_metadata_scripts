...
inFile1 = fullfile(basePath,'field_data','metadata','Arctic',campaign,'July_2023','ArcticCC_2023_NortonSound_SBA_Radiometry_Field_Log_REFORMAT.xlsx');
outPath = fullfile(basePath,'field_data','metadata','Arctic',campaign,'July_2023');

% for cruises={'Alakanuk'}
for cruises={'NortonSound'}
    cruise = char(cruises);
    metadata = struct();
